...
export const audienceProfiles: Record<AudienceId, AudienceProfile> = {
  ...
  agence: {
    ...
    short: "Resp. agence",
    description: "Animation commerciale, supports et remontées terrain.",
    tools: [
      { label: "Pixel", desc: "Intranet et contenus internes" },
      { label: "Qlik", desc: "Pilotage chiffré" },
      { label: "CRM", desc: "Suivi commercial" },
      { label: "Yoobic", desc: "Suivi terrain" },
    ...
    dashboard: [
      {
        ...
        cards: [
          { name: "Calendrier opérations", desc: "Voir les opérations à venir", action: "Voir", to: "/commerce" },
          { name: "Opération du moment", desc: "Accéder au kit en cours", action: "Ouvrir", to: "/commerce" },
        ],
      },
      {
        title: "Supports utiles",
        cards: [
          { name: "Supports commerciaux", desc: "Accéder aux kits et PLV", action: "Télécharger", to: "/commerce" },
          { name: "CRM", desc: "Suivi commercial et client", action: "Ouvrir" },
          { name: "Yoobic", desc: "Suivi terrain et animations", action: "Accéder" },
        ],
      },
      {
      ...
      },
      {
        ...
        cards: [
          ...
          { name: "Bonnes idées terrain", desc: "Consulter les idées partagées", action: "Lire", to: "/idees" },
        ],
      },
      {
    ...
    news: [
      { tag: "Commerce", date: "5 mai 2026", title: "Opération commerciale en cours", excerpt: "Kit Printemps Énergie disponible — supports et argumentaires prêts." },
      { tag: "Supports", date: "3 mai 2026", title: "Supports PLV disponibles", excerpt: "PLV éclairage industriel mises à jour pour les agences." },
      { tag: "Terrain", date: "29 avril 2026", title: "Bonne idée terrain partagée", excerpt: "Kit visite client comptoir diffusé sur la DRSE." },
    ],
    events: [
      { date: "8 mai", title: "Lancement opération commerciale", location: "Toutes agences", kind: "Lancement" },
      { date: "15 mai", title: "Échéance supports PLV", location: "DRSE", kind: "Échéance" },
      { date: "20 mai", title: "Point agence / pôle", location: "Teams · 9h00", kind: "Réunion" },
      { date: "25 mai", title: "Date limite remontées terrain", location: "Boîte à questions", kind: "Échéance" },
    ],
    priorities: {
      accueilMessage: "Vue adaptée à votre activité — animation commerciale agence.",
      commerce: [
        { label: "Opération du moment", to: "/commerce" },
      ...
      onboarding: [
        ...
        { label: "Soon", href: "#" },
        { label: "Modes opératoires", to: "/onboarding" },
        { label: "Procédures d'intégration", to: "/onboarding" },
